...
class Model(object):
    def __init__(self):
        # Load the model
        self.llm_appraisal = ChatGroq(model="llama3-70b-8192",temperature=0,
                            api_key="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")
        self.llm_response = ChatGroq(model="llama3-70b-8192",temperature=0,
                            api_key="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")
        self.llm_summarize = ChatGroq(model="llama3-70b-8192",temperature=0,
                            api_key="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")
